  ...
  return (
    <div className="h-full flex items-center ml-4">
        <img
          ...
          src={ cookies.get('image') ? cookies.get('image') :  "https://lh3.googleusercontent.com/-5wrzx0S6Dlo/AAAAAAAAAAI/AAAAAAAAAAA/ACHi3rd5-UYFTMAPPwq2-0596kcIYASp6Q/photo.jpg"}
        />
    </div>
  );
}

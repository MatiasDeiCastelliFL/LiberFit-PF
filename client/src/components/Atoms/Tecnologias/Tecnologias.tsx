...
function Tecnologias() {
    ...
    return (
        <div>
            <div className="flex justify-center 3xl:mr-16 xl2:mr-12 xl:mr-16 lg:mr-16">
                <h2 className="text-2xl font-semibold text-redClare">
                    Tecnologias
                </h2>
            </div>
            <div className="w-max xl:mt-8 lg:mt-2">
                <div className="flex flex-wrap gap-28 xl2:w-96 xl:w-96 lg:w-96 xl:justify-around lg:justify-around  justify-start xl2:justify-around 3xl:w-tec 3xl:mr-10 xl2:mr-16 lg:mr-20 ">
                    {tec.map((t) => (

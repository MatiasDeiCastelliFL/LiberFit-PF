...
function CardAbout({
    ...
    return (
        <div className="h-card">
            <div className="group border-4 border-transparent hover:border-redClare hover:border-opacity-10  3xl:w-80 xl2:w-44 xl:w-54 rounded-lg transition-all ease-in delay-75">
                <div className="">
                    <img
                        src={image}
                        alt=""
                        className="3xl:w-80 xl2:w-80 rounded-full group-hover:rounded-t-xl transition-all ease-in-out delay-75"
                    />
                </div>
                <div className="mt-5 h-0 m-0 opacity-0 group-hover:m-5 group-hover:xl2:m-1 group-hover:xl2:ml-5 group-hover:xl2:mr-3 group-hover:xl2:mt-5 group-hover:xl:m-1 group-hover:xl:ml-5 group-hover:xl:mr-3 group-hover:xl:mt-5   group-hover:h-36  group-hover:opacity-100 transition-all ease-in delay-75">
                    <div className="">
                        <h1 className="3xl:text-3xl mb-3 xl2:text-20 m-0 lg:text-2xl ">{name}</h1>
                    </div>
                    <div className="mt-2">
                        <p className="3xl:text-base xl2:text-sm xl:text-12 lg:text-lg">{description}</p>
                    </div>
                </div>
                <div className="">

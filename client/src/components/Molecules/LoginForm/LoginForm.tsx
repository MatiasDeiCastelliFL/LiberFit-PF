                 ...
                 <div className="w-3/5 p-5">
                    ...
                    <div className="flex flex-col items-center">
                        <div className=" bg-redGray w-64 p-2 flex items-center mb-3">
                            ...
                            <input onChange={handleChange} value={input.username} type="username" name="username" placeholder="username.." className="bg-redGray outline-none text-sm flex-1 "/>
                        </div>
                        <div className=" bg-redGray w-64 p-2 flex items-center mb-3">
                            <MdLockOutline className="m-2"/>
                            <input onChange={handleChange} value={input.password} type="password" name="password" placeholder="password.." className="bg-redGray outline-none text-sm flex-1" />
                        </div>
